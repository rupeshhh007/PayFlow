...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login(token); // AuthContext handles navigation — don't call navigate() again
  ...
  return (
    ...
    >
      ...
      >
            ...
            >
              {provider === "Google" ? (
                <svg width="15" height="15" viewBox="0 0 24 24">
                  ...
                  <path fill="#34A853" d="M16.04 18.013C14.951 18.716 13.566 19.09 12 19.09c-3.133 0-5.78-2.013-6.723-4.822L1.237 17.335C3.193 21.294 7.265 24 12 24c2.933 0 5.735-1.043 7.834-3.001l-3.794-2.986z" />
                  <path fill="#4A90E2" d="M19.834 20.999C21.961 19.07 23.273 16.245 23.273 12c0-.709-.091-1.473-.228-2.182H12v4.636h6.182c-.318 1.468-1.179 2.618-2.176 3.559l3.828 2.986z" />
                  <path fill="#FBBC05" d="M5.277 14.268A7.12 7.12 0 0 1 4.91 12c0-.782.125-1.533.356-2.235L1.24 6.65A11.934 11.934 0 0 0 0 12c0 1.92.445 3.73 1.237 5.335l4.04-3.067z" />
                </svg>
              ) : (
            ...
            <label className="flex items-center gap-2.5 cursor-pointer group select-none">
              <div
                ...
                style={{
                  ...
                  boxShadow: rememberMe ? "0 0 8px rgba(37,99,235,0.4)" : "none",
                }}
        ...
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#38bdf8" strokeWidth="2" className="flex-shrink-0">
